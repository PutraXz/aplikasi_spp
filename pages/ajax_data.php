...
<?php
        ...
        if($_POST['bulan'] == 'all'){
            echo "<button type='submit' name='generate' class='btn btn-primary' class='btn btn-primary'>Generate Laporan</button>";
        }else{
    ?>  
    ...
    <?php
         echo "<button type='submit' name='generate' class='btn btn-primary'>Generate Laporan</button>";
    }
    }elseif($page == 'laporan'){
        if($_POST['tahun']=="all"){
            echo "<button type='submit' name='generate' class='btn btn-primary'>Generate Laporan</button>";
